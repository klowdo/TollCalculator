...
namespace TollCalculator.Tests
{
    public class VisitorToll_Test
    {
            ...
            params IPassFeeRuleSpecification[] passFeeRules)
        {
            ...
            return new VisitorTollCalculator(
                new IVisitor<VehicleTollContext>[]
                {
                    new FeeVisitor(feeRuleRepo),
                    new TollFreeVehicleVisitor(CreateBoolService<ITollFreeVehiclesService>(tollFreeVehicles)),
                    new TollFreeDateVisitor(CreateBoolService<ITollFreeDateService>(tollFreeDate)), 
                    new SortByOccuranceVisitor(),
                    new TimeRangeGroupVisitor(_config), 
                    new MaxFeePerDayVisitor(_config),
                }, _config);
